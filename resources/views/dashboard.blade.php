            ...
            <div class="col-sm-12 col-md-12 col-xl-12">
                ...
                <a href="javascript::void(0)" class="card card-custom bg-danger bg-hover-state-danger card-stretch gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <div class="font-weight-bold text-inverse-white font-size-sm">{{ auth()->user()->payment->current_balance }}</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Stats Widget 13-->
            ...
            <div class="col-sm-6 col-md-6 col-xl-6">
                ...
                <a href="javascript::void(0)" class="card card-custom bg-warning bg-hover-state-danger card-stretch gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">Total Deposit</div>
                        <div class="font-weight-bold text-inverse-white font-size-sm">{{ auth()->user()->totalDeposit() }}</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Stats Widget 13-->
            ...
            <div class="col-sm-6 col-md-6 col-xl-6">
                ...
                <a href="javascript::void(0)" class="card card-custom bg-danger bg-hover-state-danger card-stretch gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">Total Withdraw</div>
                        <div class="font-weight-bold text-inverse-white font-size-sm">{{ auth()->user()->totalWithdraw() }}</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Stats Widget 13-->
