            ...
            <div class="col-xl-4">
                ...
                <a href="javascript::void(0)" class="card card-custom bg-primary bg-hover-state-primary card-stretch gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <div class="font-weight-bold text-inverse-white font-size-sm">{{ auth()->user()->payment->reference_bonus }}</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Stats Widget 14-->
            ...
            <div class="col-xl-4">
                ...
                <a href="javascript::void(0)" class="card card-custom bg-success bg-hover-state-success card-stretch gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">Dummy Amount</div>
                        <div class="font-weight-bold text-inverse-white font-size-sm">1000</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Stats Widget 15-->
