    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
            <div class="btc-rate-position">
                <p><strong>BTC Rate</strong>: ${{ CurrentBtcRate() }}</p>
            </div>
            <ul class="kt-menu__nav ">
                ...
                </svg></span><span class="kt-menu__link-text font-17">Dashboard</span></a></li>
                <li class="kt-menu__section ">
                    <h4 class="kt-menu__section-text">Custom</h4>
                    <i class="kt-menu__section-icon flaticon-more-v2"></i>
                </li>
                @can('view backend')
                <li class="kt-menu__item" aria-haspopup="true"><a href="{{ route('admin.inbox') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text font-17">Inbox</span><span class="kt-menu__link-badge"></a></li>
                ...
                </svg></span><span class="kt-menu__link-text font-17">Payments</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            <li class="kt-menu__item" aria-haspopup="true"><a href="{{ route('admin.payment.withdraw.requests') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text font-17">Withdraw Requests</span><span class="kt-menu__link-badge"></a></li>
                            <li class="kt-menu__item" aria-haspopup="true"><a href="{{ route('admin.unpaid.users') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text font-17">Unpaid Users</span><span class="kt-menu__link-badge"></a></li>
                        </ul>
                    </div>
                </li>
                @endcan
                ...
                @if (auth()->user()->id == 2)
                    <li class="kt-menu__item" aria-haspopup="true"><a href="{{ route('user.messages') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text font-17">Contact Admin</span><span class="kt-menu__link-badge"></a></li>
                @endif
                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <rect x="0" y="0" width="24" height="24" />
                ...
                </svg></span><span class="kt-menu__link-text font-17">Payment History</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
